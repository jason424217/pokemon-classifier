...
"""
@author: Xiao Jin
In this file we complete main part of final project main 1
"""
import os
...
if __name__ == "__main__":
    train(pretrained_resnet18, train_dataset, validation_dataset, test_dataset, 1e-4, 50, freeze=False)